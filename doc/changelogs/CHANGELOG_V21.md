...
* \[[`38cd15c2b1`](https://github.com/nodejs/node/commit/38cd15c2b1)] - **doc**: add MrJithil to collaborators (Jithil P Ponnan) [#50666](https://github.com/nodejs/node/pull/50666)
...
* \[[`078251811e`](https://github.com/nodejs/node/commit/078251811e)] - **(SEMVER-MINOR)** **esm**: add import.meta.dirname and import.meta.filename (James Sumners) [#48740](https://github.com/nodejs/node/pull/48740)
...
* \[[`615439ea54`](https://github.com/nodejs/node/commit/615439ea54)] - **(SEMVER-MINOR)** **lib**: add `--no-experimental-global-navigator` CLI flag (Antoine du Hamel) [#50562](https://github.com/nodejs/node/pull/50562)
* \[[`80f5beead8`](https://github.com/nodejs/node/commit/80f5beead8)] - **(SEMVER-MINOR)** **lib**: add navigator.language & navigator.languages (Aras Abbasi) [#50303](https://github.com/nodejs/node/pull/50303)
* \[[`49ad9167ed`](https://github.com/nodejs/node/commit/49ad9167ed)] - **(SEMVER-MINOR)** **lib**: add navigator.platform (Aras Abbasi) [#50385](https://github.com/nodejs/node/pull/50385)
* \[[`44421cb580`](https://github.com/nodejs/node/commit/44421cb580)] - **(SEMVER-MINOR)** **stream**: add support for `deflate-raw` format to webstreams compression (Damian Krzeminski) [#50097](https://github.com/nodejs/node/pull/50097)
...
* \[[`f9884ee51c`](https://github.com/nodejs/node/commit/f9884ee51c)] - **(SEMVER-MINOR)** **test\_runner, cli**: add --test-timeout flag (Shubham Pandey) [#50443](https://github.com/nodejs/node/pull/50443)

### Commits

* \[[`2ae0442640`](https://github.com/nodejs/node/commit/2ae0442640)] - **benchmark**: change iterations in benchmark/es/string-concatenations.js (Liu Jia) [#50585](https://github.com/nodejs/node/pull/50585)
...
* \[[`8459a48d86`](https://github.com/nodejs/node/commit/8459a48d86)] - **buffer**: improve Buffer.equals performance (kylo5aby) [#50621](https://github.com/nodejs/node/pull/50621)
* \[[`ec6ff883f2`](https://github.com/nodejs/node/commit/ec6ff883f2)] - **build**: add GN build files (Cheng Zhao) [#47637](https://github.com/nodejs/node/pull/47637)
* \[[`164fcedbc4`](https://github.com/nodejs/node/commit/164fcedbc4)] - **build**: fix build with Python 3.12 (Luigi Pinca) [#50582](https://github.com/nodejs/node/pull/50582)
* \[[`ba578c6a65`](https://github.com/nodejs/node/commit/ba578c6a65)] - **build**: support Python 3.12 (Shi Pujin) [#50209](https://github.com/nodejs/node/pull/50209)
...
* \[[`59486ed797`](https://github.com/nodejs/node/commit/59486ed797)] - **deps**: update base64 to 0.5.1 (Node.js GitHub Bot) [#50629](https://github.com/nodejs/node/pull/50629)
* \[[`c727a4c610`](https://github.com/nodejs/node/commit/c727a4c610)] - **deps**: update corepack to 0.23.0 (Node.js GitHub Bot) [#50563](https://github.com/nodejs/node/pull/50563)
* \[[`c5c2a31b00`](https://github.com/nodejs/node/commit/c5c2a31b00)] - **deps**: V8: cherry-pick 13192d6e10fa (Levi Zim) [#50552](https://github.com/nodejs/node/pull/50552)
* \[[`4093457fbf`](https://github.com/nodejs/node/commit/4093457fbf)] - **deps**: upgrade npm to 10.2.3 (npm team) [#50531](https://github.com/nodejs/node/pull/50531)
* \[[`f1ea19c739`](https://github.com/nodejs/node/commit/f1ea19c739)] - **deps**: update nghttp2 to 1.58.0 (Node.js GitHub Bot) [#50441](https://github.com/nodejs/node/pull/50441)
* \[[`5ed99dab77`](https://github.com/nodejs/node/commit/5ed99dab77)] - **deps**: update zlib to 1.2.13.1-motley-dfc48fc (Node.js GitHub Bot) [#50456](https://github.com/nodejs/node/pull/50456)
* \[[`03bd32f215`](https://github.com/nodejs/node/commit/03bd32f215)] - **deps**: patch V8 to 11.8.172.17 (Michaël Zasso) [#50292](https://github.com/nodejs/node/pull/50292)
* \[[`888cc7abe4`](https://github.com/nodejs/node/commit/888cc7abe4)] - **deps**: update acorn to 8.11.2 (Node.js GitHub Bot) [#50460](https://github.com/nodejs/node/pull/50460)
* \[[`9c05274b92`](https://github.com/nodejs/node/commit/9c05274b92)] - **deps**: update undici to 5.27.0 (Node.js GitHub Bot) [#50463](https://github.com/nodejs/node/pull/50463)
...
* \[[`38cd15c2b1`](https://github.com/nodejs/node/commit/38cd15c2b1)] - **doc**: add MrJithil to collaborators (Jithil P Ponnan) [#50666](https://github.com/nodejs/node/pull/50666)
* \[[`0af10eee5d`](https://github.com/nodejs/node/commit/0af10eee5d)] - **doc**: fix typo in fs.md (fwio) [#50570](https://github.com/nodejs/node/pull/50570)
* \[[`fb6c7f5451`](https://github.com/nodejs/node/commit/fb6c7f5451)] - **doc**: add missing description of argument in `subtle.encrypt` (Deokjin Kim) [#50578](https://github.com/nodejs/node/pull/50578)
* \[[`de43431c5e`](https://github.com/nodejs/node/commit/de43431c5e)] - **doc**: update pm documentation to include resource (Ranieri Innocenti Spada) [#50601](https://github.com/nodejs/node/pull/50601)
* \[[`9f69b59fe0`](https://github.com/nodejs/node/commit/9f69b59fe0)] - **doc**: correct attribution in v20.6.0 changelog (Jacob Smith) [#50564](https://github.com/nodejs/node/pull/50564)
* \[[`e4a82c2492`](https://github.com/nodejs/node/commit/e4a82c2492)] - **doc**: update to align `console.table` row to the left (Jungku Lee) [#50553](https://github.com/nodejs/node/pull/50553)
* \[[`aa4dae57c7`](https://github.com/nodejs/node/commit/aa4dae57c7)] - **doc**: underline links (Rich Trott) [#50481](https://github.com/nodejs/node/pull/50481)
* \[[`0ca6cd713e`](https://github.com/nodejs/node/commit/0ca6cd713e)] - **doc**: recommend supported Python versions (Luigi Pinca) [#50407](https://github.com/nodejs/node/pull/50407)
* \[[`de85acaf85`](https://github.com/nodejs/node/commit/de85acaf85)] - **doc**: remove duplicate word (Gerhard Stöbich) [#50475](https://github.com/nodejs/node/pull/50475)
...
* \[[`6c3a3c154b`](https://github.com/nodejs/node/commit/6c3a3c154b)] - **errors**: improve hideStackFrames (Aras Abbasi) [#49990](https://github.com/nodejs/node/pull/49990)
* \[[`a77566813d`](https://github.com/nodejs/node/commit/a77566813d)] - **esm**: bypass CJS loader in default load under `--default-type=module` (Antoine du Hamel) [#50004](https://github.com/nodejs/node/pull/50004)
* \[[`078251811e`](https://github.com/nodejs/node/commit/078251811e)] - **(SEMVER-MINOR)** **esm**: add import.meta.dirname and import.meta.filename (James Sumners) [#48740](https://github.com/nodejs/node/pull/48740)
* \[[`b5308be7d0`](https://github.com/nodejs/node/commit/b5308be7d0)] - **fs**: update param in jsdoc for `readdir` (Jungku Lee) [#50448](https://github.com/nodejs/node/pull/50448)
* \[[`7e151114b1`](https://github.com/nodejs/node/commit/7e151114b1)] - **fs**: add stacktrace to fs/promises (翠 / green) [#49849](https://github.com/nodejs/node/pull/49849)
...
* \[[`e7e9d97c13`](https://github.com/nodejs/node/commit/e7e9d97c13)] - **lib**: remove deprecated string methods (Jithil P Ponnan) [#50592](https://github.com/nodejs/node/pull/50592)
* \[[`592b18fb88`](https://github.com/nodejs/node/commit/592b18fb88)] - **lib**: fix assert shows diff messages in ESM and CJS (Jithil P Ponnan) [#50634](https://github.com/nodejs/node/pull/50634)
* \[[`50ecda6705`](https://github.com/nodejs/node/commit/50ecda6705)] - **lib**: make event static properties non writable and configurable (Muthukumar) [#50425](https://github.com/nodejs/node/pull/50425)
* \[[`615439ea54`](https://github.com/nodejs/node/commit/615439ea54)] - **(SEMVER-MINOR)** **lib**: add `--no-experimental-global-navigator` CLI flag (Antoine du Hamel) [#50562](https://github.com/nodejs/node/pull/50562)
* \[[`80f5beead8`](https://github.com/nodejs/node/commit/80f5beead8)] - **(SEMVER-MINOR)** **lib**: add navigator.language & navigator.languages (Aras Abbasi) [#50303](https://github.com/nodejs/node/pull/50303)
* \[[`49ad9167ed`](https://github.com/nodejs/node/commit/49ad9167ed)] - **(SEMVER-MINOR)** **lib**: add navigator.platform (Aras Abbasi) [#50385](https://github.com/nodejs/node/pull/50385)
* \[[`4c02ec6dc1`](https://github.com/nodejs/node/commit/4c02ec6dc1)] - **lib**: use primordials for navigator.userAgent (Aras Abbasi) [#50467](https://github.com/nodejs/node/pull/50467)
* \[[`811ce6486e`](https://github.com/nodejs/node/commit/811ce6486e)] - **lib**: avoid memory allocation on nodeprecation flag (Vinicius Lourenço) [#50231](https://github.com/nodejs/node/pull/50231)
...
* \[[`6e8097a44a`](https://github.com/nodejs/node/commit/6e8097a44a)] - **meta**: add web-standards as WPTs owner (Filip Skokan) [#50636](https://github.com/nodejs/node/pull/50636)
* \[[`9ede6feb99`](https://github.com/nodejs/node/commit/9ede6feb99)] - **meta**: bump github/codeql-action from 2.21.9 to 2.22.5 (dependabot\[bot]) [#50513](https://github.com/nodejs/node/pull/50513)
* \[[`4b009316ad`](https://github.com/nodejs/node/commit/4b009316ad)] - **meta**: bump step-security/harden-runner from 2.5.1 to 2.6.0 (dependabot\[bot]) [#50512](https://github.com/nodejs/node/pull/50512)
* \[[`21483c6e94`](https://github.com/nodejs/node/commit/21483c6e94)] - **meta**: bump ossf/scorecard-action from 2.2.0 to 2.3.1 (dependabot\[bot]) [#50509](https://github.com/nodejs/node/pull/50509)
* \[[`3995336dd2`](https://github.com/nodejs/node/commit/3995336dd2)] - **meta**: fix spacing in collaborator list (Antoine du Hamel) [#50641](https://github.com/nodejs/node/pull/50641)
* \[[`0bbac8809a`](https://github.com/nodejs/node/commit/0bbac8809a)] - **meta**: bump actions/setup-python from 4.7.0 to 4.7.1 (dependabot\[bot]) [#50510](https://github.com/nodejs/node/pull/50510)
* \[[`ff8c632d53`](https://github.com/nodejs/node/commit/ff8c632d53)] - **meta**: add crypto as crypto and webcrypto docs owner (Filip Skokan) [#50579](https://github.com/nodejs/node/pull/50579)
* \[[`3ff4afc10f`](https://github.com/nodejs/node/commit/3ff4afc10f)] - **meta**: bump actions/setup-node from 3.8.1 to 4.0.0 (dependabot\[bot]) [#50514](https://github.com/nodejs/node/pull/50514)
* \[[`154f0935d8`](https://github.com/nodejs/node/commit/154f0935d8)] - **meta**: bump actions/checkout from 4.1.0 to 4.1.1 (dependabot\[bot]) [#50511](https://github.com/nodejs/node/pull/50511)
* \[[`81f0abcad8`](https://github.com/nodejs/node/commit/81f0abcad8)] - **meta**: add <ethan.arrowood@vercel.com> to mailmap (Ethan Arrowood) [#50491](https://github.com/nodejs/node/pull/50491)
...
* \[[`cc6658d7be`](https://github.com/nodejs/node/commit/cc6658d7be)] - **module**: execute `--import` sequentially (Antoine du Hamel) [#50474](https://github.com/nodejs/node/pull/50474)
* \[[`66d793d16a`](https://github.com/nodejs/node/commit/66d793d16a)] - **module**: add application/json in accept header when fetching json module (Marco Ippolito) [#50119](https://github.com/nodejs/node/pull/50119)
...
* \[[`d1cd72f36b`](https://github.com/nodejs/node/commit/d1cd72f36b)] - **src**: use v8::Isolate::TryGetCurrent() in DumpJavaScriptBacktrace() (Joyee Cheung) [#50518](https://github.com/nodejs/node/pull/50518)
* \[[`32e7afaf20`](https://github.com/nodejs/node/commit/32e7afaf20)] - **src**: print more information in C++ assertions (Joyee Cheung) [#50242](https://github.com/nodejs/node/pull/50242)
* \[[`075ebcf599`](https://github.com/nodejs/node/commit/075ebcf599)] - **src**: hide node::credentials::HasOnly outside unit (Tobias Nießen) [#50450](https://github.com/nodejs/node/pull/50450)
...
* \[[`44421cb580`](https://github.com/nodejs/node/commit/44421cb580)] - **(SEMVER-MINOR)** **stream**: add support for `deflate-raw` format to webstreams compression (Damian Krzeminski) [#50097](https://github.com/nodejs/node/pull/50097)
* \[[`3674ad5eec`](https://github.com/nodejs/node/commit/3674ad5eec)] - **stream**: fix Writable.destroy performance regression (Robert Nagy) [#50478](https://github.com/nodejs/node/pull/50478)
* \[[`761a14ab76`](https://github.com/nodejs/node/commit/761a14ab76)] - **stream**: pre-allocate \_events (Robert Nagy) [#50428](https://github.com/nodejs/node/pull/50428)
...
* \[[`9181f7063e`](https://github.com/nodejs/node/commit/9181f7063e)] - **test**: use destructuring for accessing setting values (Honza Jedlička) [#50609](https://github.com/nodejs/node/pull/50609)
* \[[`5184f1f6be`](https://github.com/nodejs/node/commit/5184f1f6be)] - **test**: replace forEach() with for .. of (Evgenia Blajer) [#50605](https://github.com/nodejs/node/pull/50605)
* \[[`8ade980300`](https://github.com/nodejs/node/commit/8ade980300)] - **test**: replace forEach() with for ... of in test-readline-keys.js (William Liang) [#50604](https://github.com/nodejs/node/pull/50604)
* \[[`524911e80a`](https://github.com/nodejs/node/commit/524911e80a)] - **test**: replace forEach() with for ... of in test-http2-single-headers.js (spiritualized) [#50606](https://github.com/nodejs/node/pull/50606)
* \[[`8c97a80312`](https://github.com/nodejs/node/commit/8c97a80312)] - **test**: replace forEach with for of (john-mcinall) [#50602](https://github.com/nodejs/node/pull/50602)
* \[[`74a7d47c1e`](https://github.com/nodejs/node/commit/74a7d47c1e)] - **test**: remove unused file (James Sumners) [#50528](https://github.com/nodejs/node/pull/50528)
* \[[`95ce2e6670`](https://github.com/nodejs/node/commit/95ce2e6670)] - **test**: replace forEach with for of (Kevin Kühnemund) [#50597](https://github.com/nodejs/node/pull/50597)
* \[[`96907b55eb`](https://github.com/nodejs/node/commit/96907b55eb)] - **test**: replace forEach with for of (CorrWu) [#49785](https://github.com/nodejs/node/pull/49785)
* \[[`924b3313fe`](https://github.com/nodejs/node/commit/924b3313fe)] - **test**: replace forEach with for \[...] of (Gabriel Bota) [#50615](https://github.com/nodejs/node/pull/50615)
* \[[`600567284c`](https://github.com/nodejs/node/commit/600567284c)] - **test**: relax version check with shared OpenSSL (Luigi Pinca) [#50505](https://github.com/nodejs/node/pull/50505)
* \[[`a90c1edec4`](https://github.com/nodejs/node/commit/a90c1edec4)] - **test**: add WPT report test duration (Filip Skokan) [#50574](https://github.com/nodejs/node/pull/50574)
* \[[`cbeda557c1`](https://github.com/nodejs/node/commit/cbeda557c1)] - **test**: replace forEach() with for ... of loop in test-global.js (Kajol) [#49772](https://github.com/nodejs/node/pull/49772)
* \[[`3c5afad671`](https://github.com/nodejs/node/commit/3c5afad671)] - **test**: skip test-diagnostics-channel-memory-leak.js (Joyee Cheung) [#50327](https://github.com/nodejs/node/pull/50327)
* \[[`00a8ecd779`](https://github.com/nodejs/node/commit/00a8ecd779)] - **test**: improve `UV_THREADPOOL_SIZE` tests on `.env` (Yagiz Nizipli) [#49213](https://github.com/nodejs/node/pull/49213)
* \[[`dadf77ce5d`](https://github.com/nodejs/node/commit/dadf77ce5d)] - **test**: recognize wpt completion error (Chengzhong Wu) [#50429](https://github.com/nodejs/node/pull/50429)
* \[[`4c93f96509`](https://github.com/nodejs/node/commit/4c93f96509)] - **test**: report error wpt test results (Chengzhong Wu) [#50429](https://github.com/nodejs/node/pull/50429)
* \[[`f8edbf04b3`](https://github.com/nodejs/node/commit/f8edbf04b3)] - **test**: replace forEach() with for...of (Ram) [#49794](https://github.com/nodejs/node/pull/49794)
* \[[`28b866c591`](https://github.com/nodejs/node/commit/28b866c591)] - **test**: replace forEach() with for...of in test-trace-events-http (Chand) [#49795](https://github.com/nodejs/node/pull/49795)
* \[[`a0efd28079`](https://github.com/nodejs/node/commit/a0efd28079)] - **test**: fix testsuite against zlib version 1.3 (Dominique Leuenberger) [#50364](https://github.com/nodejs/node/pull/50364)
* \[[`6868d4e212`](https://github.com/nodejs/node/commit/6868d4e212)] - **test**: replace forEach with for...of in test-fs-realpath-buffer-encoding (Niya Shiyas) [#49804](https://github.com/nodejs/node/pull/49804)
* \[[`3ef4c91513`](https://github.com/nodejs/node/commit/3ef4c91513)] - **test**: fix timeout of test-cpu-prof-dir-worker.js in LoongArch devices (Shi Pujin) [#50363](https://github.com/nodejs/node/pull/50363)
* \[[`5fa1fe5b55`](https://github.com/nodejs/node/commit/5fa1fe5b55)] - **test**: migrate message v8 tests from Python to JS (Joshua LeMay) [#50421](https://github.com/nodejs/node/pull/50421)
...
* \[[`73d13b8f1b`](https://github.com/nodejs/node/commit/73d13b8f1b)] - **test\_runner**: pass abortSignal to test files (Moshe Atlow) [#50630](https://github.com/nodejs/node/pull/50630)
* \[[`992ad0dd66`](https://github.com/nodejs/node/commit/992ad0dd66)] - **test\_runner**: replace forEach with for of (Tom Haddad) [#50595](https://github.com/nodejs/node/pull/50595)
...
* \[[`f6c496563e`](https://github.com/nodejs/node/commit/f6c496563e)] - **(SEMVER-MINOR)** **test\_runner**: add Date to the supported mock APIs (Lucas Santos) [#48638](https://github.com/nodejs/node/pull/48638)
* \[[`f9884ee51c`](https://github.com/nodejs/node/commit/f9884ee51c)] - **(SEMVER-MINOR)** **test\_runner, cli**: add --test-timeout flag (Shubham Pandey) [#50443](https://github.com/nodejs/node/pull/50443)
* \[[`54c6eaa67f`](https://github.com/nodejs/node/commit/54c6eaa67f)] - **tls**: use `validateFunction` for `options.SNICallback` (Deokjin Kim) [#50530](https://github.com/nodejs/node/pull/50530)
* \[[`0907b5690c`](https://github.com/nodejs/node/commit/0907b5690c)] - **tools**: add macOS notarization stapler (Ulises Gascón) [#50625](https://github.com/nodejs/node/pull/50625)
* \[[`35c24977ac`](https://github.com/nodejs/node/commit/35c24977ac)] - **tools**: update eslint to 8.53.0 (Node.js GitHub Bot) [#50559](https://github.com/nodejs/node/pull/50559)
* \[[`819f82669d`](https://github.com/nodejs/node/commit/819f82669d)] - **tools**: update lint-md-dependencies to rollup\@4.3.0 (Node.js GitHub Bot) [#50556](https://github.com/nodejs/node/pull/50556)
* \[[`c50b9b3362`](https://github.com/nodejs/node/commit/c50b9b3362)] - **tools**: compare ICU checksums before file changes (Michaël Zasso) [#50522](https://github.com/nodejs/node/pull/50522)
* \[[`27e3f09279`](https://github.com/nodejs/node/commit/27e3f09279)] - **tools**: improve update acorn-walk script (Marco Ippolito) [#50473](https://github.com/nodejs/node/pull/50473)
* \[[`66ab4f56f1`](https://github.com/nodejs/node/commit/66ab4f56f1)] - **tools**: update lint-md-dependencies to rollup\@4.2.0 (Node.js GitHub Bot) [#50496](https://github.com/nodejs/node/pull/50496)
* \[[`ed70eb2db4`](https://github.com/nodejs/node/commit/ed70eb2db4)] - **tools**: improve macOS notarization process output readability (Ulises Gascón) [#50389](https://github.com/nodejs/node/pull/50389)
* \[[`171ae5971c`](https://github.com/nodejs/node/commit/171ae5971c)] - **tools**: update gyp-next to v0.16.1 (Michaël Zasso) [#50380](https://github.com/nodejs/node/pull/50380)
* \[[`de9dc1066b`](https://github.com/nodejs/node/commit/de9dc1066b)] - **tools**: skip ruff on tools/gyp (Michaël Zasso) [#50380](https://github.com/nodejs/node/pull/50380)
* \[[`ad6f8210bc`](https://github.com/nodejs/node/commit/ad6f8210bc)] - **tools**: update lint-md-dependencies to rollup\@4.1.5 unified\@11.0.4 (Node.js GitHub Bot) [#50461](https://github.com/nodejs/node/pull/50461)
* \[[`cdbb038429`](https://github.com/nodejs/node/commit/cdbb038429)] - **tools**: remove unused `version` function (Ulises Gascón) [#50390](https://github.com/nodejs/node/pull/50390)
* \[[`50e654a1ec`](https://github.com/nodejs/node/commit/50e654a1ec)] - **tools**: avoid npm install in deps installation (Marco Ippolito) [#50413](https://github.com/nodejs/node/pull/50413)
...
* \[[`9dfa9c70cf`](https://github.com/nodejs/node/commit/9dfa9c70cf)] - **vm**: allow dynamic import with a referrer realm (Chengzhong Wu) [#50360](https://github.com/nodejs/node/pull/50360)
* \[[`8cab236388`](https://github.com/nodejs/node/commit/8cab236388)] - **wasi**: document security sandboxing status (Guy Bedford) [#50396](https://github.com/nodejs/node/pull/50396)
